...
import ShieldPreview from '../customization/shield/shieldPreview'

const Product: React.FC = () => {
	// context de comunicação com o display
	// const [render, setRender] = useContext<any>(DisplayContext2)
	const { data, shieldPosition, shieldShortPosition } = useContext(
		DisplayContext
	)
			...
			<div>
				<Styles.Container>
					<Styles.Product>
						...
						<span>
							<Md1 fill={color.camiseta.cores[0]} />
						</span>
						<span>
							<Me1 fill={color.camiseta.cores[0]} />
						</span>
						<span>
						...
						{/* short */}
						<span>
							<Sd1 fill={color.short.cores[0]} />
						</span>
						<span>
							<Se1 fill={color.short.cores[0]} />
						</span>
						...
						{/* <Se2 fill="red" /> */}
						<Styles.Shield position={shieldPosition}>
							<ShieldPreview />
						</Styles.Shield>
						<Styles.ShieldShort position={shieldShortPosition}>
							<ShieldPreview />
						</Styles.ShieldShort>
					</Styles.Product>
